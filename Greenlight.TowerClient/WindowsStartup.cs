...
/// <summary>
/// Whether the tower comes back when Windows does. One value under the current user's
...
/// <c>tower.json</c>: the user can turn the same thing off in Task Manager's Startup tab or
...
public static class WindowsStartup
{
    ...
    /// </summary>
    private const string ValueName = "Greenlight Tower";

    /// <summary>Whether Windows is currently set to start the tower.</summary>
    ...
    /// <summary>Ask Windows to start the tower, or stop asking. Returns what it actually is afterwards.</summary>
    ...
    /// </summary>
    /// <remarks>
    /// A Velopack install looks like <c>…\Greenlight.TowerClient\current\Greenlight.TowerClient.exe</c>,
